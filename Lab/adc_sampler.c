...
#define MISO2 12    // ADC 2 MISO (GPIO pin number)
#define MISO3 16    // ADC 3 MISO (GPIO pin number)
#define MISO4 20    // ADC 4 MISO (GPIO pin number)
#define MISO5 21    // ADC 5 MISO (GPIO pin number)
